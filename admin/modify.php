...
<?
$result = mysql_query("select * from member where team = '".$_GET['jno']."'");
$obj2 = mysql_fetch_object($result);

if($obj2->register == 0){ //未報名?>
<p><?echo $_GET['jno'];?>尚未報名</p>
<?}
else{ //已報名 
...
<form name="form1" method="post">
	...
	<input type="hidden" name="jno" id="jno" value="<?echo $_GET['jno'];?>" />
